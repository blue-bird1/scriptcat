...
(() => {
  ...
  var LOG_PREFIX = "[zlib-download-history-sync]";
  var STORE_KEY = "downloadedBooks";
  var PAGE_KEY = "downloadedBooks";
  ...
  function mergeDownloadedBooks(existing, incoming) {
