...
const TOOLBAR_ID = "gmg-steam-claim-helper";
const SESSION_ID_KEY = "gmgSteamClaimHelperSessionId";
const KEY_PATTERN = /^(?:(?:([A-Z0-9])(?!\1{4})){5}-){2,5}[A-Z0-9]{5}$/;
const ACTIVATION_DELAY_MS = 2000;
const STEAM_REGISTER_URL = "https://store.steampowered.com/account/ajaxregisterkey/";
const STEAM_HOME_URL = "https://store.steampowered.com/";
const STEAM_REGISTER_PAGE = "https://store.steampowered.com/account/registerkey";
...
export function startGmgBundleClaimHelper() {
